 ...
 * @author ESPRIT
 */
public class FXMLafficher1Controller implements Initializable {

    /**
     * Initializes the controller class.
     * 
     */@FXML Button afficher1;
     @FXML TextField affichage;
     ...
     public void afficher(ActionEvent event) throws SQLException
    {
        ...
        String listString;
         listString = String.join("\n ",cr.afficherlescommentaire() );
        affichage.setText(listString);
