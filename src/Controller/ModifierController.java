...
//    }
    ...
    public void retour3(ActionEvent event ) throws SQLException, IOException 
  {
    ...
    @FXML
    private void Reclam_Modif(javafx.scene.input.MouseEvent event) throws SQLException, IOException {
        ...
        cr.updateEtat(reclamTable.getSelectionModel().getSelectedItem().getId());
    ...
    public void modifier_reclamation (ActionEvent event ) throws SQLException,IOException
    {
        ...
        Reclamation rec = new Reclamation(reclamTable.getSelectionModel().getSelectedItem().getId(),sujetupdate.getText(), reclamupdate.getText());
        ...
        FXMLLoader fxmlloader = new FXMLLoader(getClass().getResource("/Views/Modifier.fxml"));
            ...
            ModifierController Adminct2= fxmlloader.<ModifierController>getController();
            Scene scene = new Scene(root,1200,800);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
